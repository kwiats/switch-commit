...
- Lokalna detekcja kont GitHub z `~/.config/gh/hosts.yml`, globalnej konfiguracji Git, konfiguracji SSH i opcjonalnego skanu `.git/config` w wybranym folderze.
...
- Detekcja nie uzywa GitHub API, `gh auth`, `git ls-remote`, `ssh -T` ani `curl`.
