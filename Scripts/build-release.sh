...
release_channel_base_url="https://kwiats.github.io/switch-commit"
sparkle_feed_url="${release_channel_base_url}/appcast.xml"
sparkle_artifact_url="https://github.com/kwiats/switch-commit/releases/download/v${version}/SwitchCommit-v${version}-macOS.dmg"
